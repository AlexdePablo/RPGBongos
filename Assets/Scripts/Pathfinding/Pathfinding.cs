    ...
    private List<Node> GetNeighbours(Node node)
    {
        ...
        */
        ...
        if (node.Position.y % 2 == 0)
        {
            ...
            newNodeCoordinates = new Vector3Int(node.Position.x - 1, node.Position.y - 1, 0);
        ...
        newNodeCoordinates = new Vector3Int(node.Position.x, node.Position.y - 1, 0);
        ...
        newNodeCoordinates = new Vector3Int(node.Position.x + -1, node.Position.y, 0);
