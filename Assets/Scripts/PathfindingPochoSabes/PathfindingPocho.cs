...
/// </summary>
public class PathfindingPocho : MonoBehaviour
{
    ...
    {
        Vector3Int posicion = new Vector3Int(node.Position.x, node.Position.y, 0);
        ...
        */
        ...
        //HEXAGONAL
        List<Vector3Int> listaVecinos = cogerVecinas(posicion);
        
        foreach(Vector3Int vecino in listaVecinos)
        {
            if (IsWalkableTile(vecino))
                neighbours.Add(new Node(vecino));
        }
        return neighbours;
    }

    public List<Vector3Int> cogerVecinas(Vector3Int posicion)
    {
        Vector3Int newNodeCoordinates;
        List<Vector3Int> neighbours = new List<Vector3Int>();
        if (posicion.y % 2 == 0)
        {
            newNodeCoordinates = new Vector3Int(posicion.x - 1, posicion.y - 1, 0);


            neighbours.Add(newNodeCoordinates);
            newNodeCoordinates = new Vector3Int(posicion.x - 1, posicion.y + 1, 0);
        ...
        newNodeCoordinates = new Vector3Int(posicion.x, posicion.y - 1, 0);
        ...
        neighbours.Add(newNodeCoordinates);
        newNodeCoordinates = new Vector3Int(posicion.x + -1, posicion.y, 0);
